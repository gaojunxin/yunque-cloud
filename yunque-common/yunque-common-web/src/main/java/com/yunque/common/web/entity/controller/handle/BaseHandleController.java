package com.yunque.common.web.entity.controller.handle;
...
import com.yunque.common.core.utils.core.TypeUtil;
import com.yunque.common.core.utils.poi.XExcelUtil;
...
public abstract class BaseHandleController<Q extends BaseEntity, D extends BaseEntity, IDS extends IBaseService<Q, D>> extends BasisController {
     ...
     * @see com.yunque.common.web.entity.controller.BaseController#batchRemove(List)
     */
